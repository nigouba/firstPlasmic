...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: gqxBWYm9CUp8/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__urSk)}>
        <div className={classNames(projectcss.all, sty.column___7ViZh)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__f3KRs)}>
          <div className={classNames(projectcss.all, sty.columns__aklGh)}>
            <div className={classNames(projectcss.all, sty.column__gQIg2)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__oivY1)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__juOWy)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__wnNi)}>
                {renderPlasmicSlot({
